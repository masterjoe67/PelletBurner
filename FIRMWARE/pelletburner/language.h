...
//Messaggi estesi
	...
	#define HELP_MAX_TIME_ACC			"Max tempo accensione"
	#define HELP_PERIODO_PULIZIA		"Periodo pulizia"
	#define HELP_STABILIZZAZIONE		"Stabilizzazione"
	#define HELP_DURATA_PULIZIA			"Durata pul. periodica"
	#define HELP_DURATA_SPEGN_STBY		"Durata speg. standby"
	#define HELP_PRESPEGNIMENTO			"Prespegnimento"
	#define HELP_PUL_SPEGN				"Pulizia spegnimento"
	#define HELP_DIS_CANDELETTA			"Disatt. candeletta"
	#define HELP_MANCANZA_FIAMMA		"Mancanza fiamma uuuuuuuuuuuuu"
//Messaggi di range
